...
export default function AgentPage() {
  ...
  function handleIdentitySave() {
    ...
    updateArtifact.mutate(
      ...
      { onSuccess: () => addToast(ta('activated'), 'success') },
    );
  }
  ...
  return (
    <div className="space-y-4 p-6">
      ...
      >
        ...
        <button
          type="button"
          className="flex shrink-0 items-center gap-1.5 rounded-md bg-teal/10 px-3 py-1.5 text-sm font-medium text-teal hover:bg-teal/20"
          onClick={() => setChatOpen(true)}
          data-testid="test-chat-btn"
        >
